...
Chatto is a *A fully-featured team and group chat application that you can easily selfhost*. It is free to use, lightweight,  easy to spin up and manage, and its international community is very friendly.
...
----
<small>
  This is a community effort not affiliated with ChattoCorp GmbH. Work licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/). Ideas? Suggestions? Come on over to [Chatto HQ](https://chat.chatto.run) and discuss! </small>
